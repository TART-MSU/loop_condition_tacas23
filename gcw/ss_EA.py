...
print('\n\n[ case: (E_big, A_small) GCW w/ solution ]')
...
# correct solution
# solver.add(a_labels[0]=='L=FWGC,R=') # correct 1
# solver.add(a_labels[1]=='L=WC,R=FG') # correct 2
# solver.add(a_labels[2]=='L=FWC,R=G') # correct 3
# solver.add(a_labels[3]=='L=W,R=FCG') # correct 4
# solver.add(a_labels[4]=='L=FGW,R=C') # correct 5
# solver.add(a_labels[5]=='L=G,R=FWC') # correct 6
# solver.add(a_labels[6]=='L=FG,R=WC') # correct 7
# solver.add(a_labels[7]=='L=,R=FWGC') # correct 8
...
solver.add(a_labels[8]=='L=GC,R=FW') # trap
solver.add(a_labels[10]=='L=FGC,R=W') # trap
solver.add(a_labels[11]=='L=C,R=FGW') # trap
solver.add(a_labels[12]=='L=FC,R=GW') # trap
solver.add(a_labels[13]=='L=,R=FWGC') # trap

solver.add(a_labels[9]=='L=GW,R=FC') # trap

solver.add(a_labels[14]=='L=W,R=FGC') # trap
solver.add(a_labels[15]=='L=FW,R=GC') # trap
solver.add(a_labels[16]=='L=,R=FWGC') # trap
...
solver.add(y_labels[0]=='') # violation one: goat + cabbage
solver.add(y_labels[1]=='L=GC,R=FW') # violation one: goat + cabbage
solver.add(y_labels[2]=='L=FW,R=GC')
solver.add(y_labels[3]=='L=GW,R=FC') # violation two: goat + wolf
solver.add(y_labels[4]=='L=FC,R=GW')
