...
solver.add(a_labels[2]=='TRUE')
solver.add(a_labels[3]=='(empty)')


solver.add(y_labels[0]=='(empty)')
solver.add(y_labels[1]=='(empty)')
solver.add(y_labels[2]=='TRUE')
solver.add(y_labels[3]=='(empty)')
solver.add(y_labels[4]=='(empty)')
solver.add(y_labels[5]=='(empty)')
solver.add(y_labels[6]=='TRUE')
solver.add(y_labels[7]=='(empty)')
solver.add(y_labels[8]=='(empty)')
