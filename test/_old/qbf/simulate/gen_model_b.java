...
public class gen_model_b{
	...
	public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
		...
		// constrcut transition relations
       	PrintWriter writer_R = new PrintWriter("model_b_R.bool", "UTF-8");
       	writer_R.write(generate_transitions());
	   	writer_R.close();

	   	// give initial values
	   	PrintWriter writer_I = new PrintWriter("model_b_I.bool", "UTF-8");
       	writer_I.write(generate_initialState());
	   	writer_I.close();

	   	// properties
	   	// PrintWriter writer_P = new PrintWriter("model_b_P.bool", "UTF-8");
	...
	private static String generate_transitions(){
		...
		tr.add(implication(currState(2), disjunct2(goto_state0, goto_state3)));
		tr.add(implication(currState(3), goto_state3));
