...
public class gen_model_a{
	...
	private static String generate_transitions(){
		...
		String goto_state2 = conjunct2(nextState(2), atom_assignFalse(var_p));
		String goto_state3 = conjunct2(nextState(3), atom_assignTrue(var_p));
		String goto_state4 = conjunct2(nextState(4), atom_assignTrue(var_p));
		


		ArrayList<String> tr = new ArrayList<>();
		tr.add(implication(currState(0), disjunct2(goto_state1, goto_state2)));
		tr.add(implication(currState(1), goto_state3));
		tr.add(implication(currState(2), goto_state4));
		tr.add(implication(currState(3), goto_state0));
		tr.add(implication(currState(4), goto_state0));
