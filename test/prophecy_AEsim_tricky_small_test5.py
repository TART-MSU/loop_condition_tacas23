...
def define_prophecy_1():
    solver.add(And((x_prophs[0] == x_labels[0]),
            (x_prophs[1] == x_labels[1]),
            (x_prophs[2] == x_labels[2]),
            (x_prophs[3] == x_labels[3])))


def define_prophecy_2():
    solver.add(And((y_prophs[0] == y_labels[0]),
            (y_prophs[1] == y_labels[1]),
            (y_prophs[2] == y_labels[2]),
            (y_prophs[3] == y_labels[3]),
            (y_prophs[4] == y_labels[4])))
...
def define_L_1():
    solver.add(And((x_labels[0] == True),
            (x_labels[1] == False),
            (x_labels[2] == True),
            (x_labels[3] == False)))

def define_L_2():
    solver.add(And((y_labels[0] == True),
            (y_labels[1] == False),
            (y_labels[2] == False),
            (y_labels[3] == False),
            (y_labels[4] == True)))
