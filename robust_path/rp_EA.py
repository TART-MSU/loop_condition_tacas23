...
print('\n\n[ case: (E_small, A_big) RP w/ solution ]')
...
print('== User Define Labeling Functions and Transitions ==')
########## user define ##########
solver.add(a_labels[0]=='x=0,y=0')
solver.add(a_labels[1]=='x=1,y=0')
solver.add(a_labels[2]=='x=2,y=0')
solver.add(a_labels[3]=='x=0,y=1')
solver.add(a_labels[4]=='x=1,y=1')
solver.add(a_labels[5]=='x=2,y=1')
solver.add(a_labels[6]=='x=0,y=2')
solver.add(a_labels[7]=='x=1,y=2')
solver.add(a_labels[8]=='x=2,y=2')
...
# solver.add(Or(y_labels[0]=='x=0,y=2', y_labels[0]=='x=2,y=2', y_labels[0]=='x=2,y=0', y_labels[0]=='x=0,y=0'))##
# solver.add(Or(y_labels[1]=='x=1,y=2', y_labels[1]=='x=2,y=2', y_labels[1]=='x=2,y=0', y_labels[1]=='x=0,y=1'))#
# solver.add(Or(y_labels[2]=='x=1,y=2', y_labels[2]=='x=2,y=1', y_labels[2]=='x=2,y=0', y_labels[2]=='x=1,y=1'))#
# solver.add(Or(y_labels[3]=='x=1,y=2', y_labels[3]=='x=2,y=1', y_labels[3]=='x=1,y=0', y_labels[3]=='x=1,y=2'))##
# solver.add(Or(y_labels[4]=='x=2,y=2', y_labels[4]=='x=2,y=0', y_labels[4]=='x=0,y=0'))##
# solver.add(Or(y_labels[5]=='x=2,y=1', y_labels[5]=='x=2,y=0', y_labels[5]=='x=0,y=0'))#
# solver.add(Or(y_labels[6]=='x=2,y=1', y_labels[6]=='x=2,y=0', y_labels[6]=='x=0,y=0'))#
# solver.add(Or(y_labels[7]=='x=2,y=1', y_labels[7]=='x=1,y=0', y_labels[7]=='x=0,y=0'))#
# solver.add(Or(y_labels[8]=='x=2,y=1', y_labels[8]=='x=1,y=0', y_labels[8]=='x=0,y=1'))#
# solver.add(Or(y_labels[9]=='x=2,y=2', y_labels[9]=='x=0,y=0', y_labels[9]=='x=0,y=2'))#

solver.add(y_labels[0]=='x=0,y=0');
solver.add(y_labels[1]=='x=0,y=1');
solver.add(y_labels[2]=='x=0,y=1');
solver.add(y_labels[3]=='x=1,y=1');
solver.add(y_labels[4]=='x=1,y=2');
solver.add(y_labels[5]=='x=1,y=2');
solver.add(y_labels[6]=='x=1,y=2');
solver.add(y_labels[7]=='x=1,y=2');
solver.add(y_labels[8]=='x=1,y=2');
solver.add(y_labels[9]=='x=1,y=2');

input_R2 = np.zeros((k,k), dtype=bool)


# solver.add(y_labels[4]=='x=2,y=2');
# solver.add(y_labels[5]=='x=2,y=2');
# solver.add(y_labels[6]=='x=2,y=2');
# solver.add(y_labels[7]=='x=2,y=2');
# solver.add(y_labels[8]=='x=2,y=2');
# solver.add(y_labels[9]=='x=2,y=2');
# solver.add(y_labels[3]=='x=1,y=2');
# solver.add(y_labels[4]=='x=1,y=2');
# solver.add(y_labels[5]=='x=2,y=1');
# solver.add(y_labels[6]=='x=1,y=1');
# solver.add(y_labels[7]=='x=1,y=1');
# solver.add(y_labels[8]=='x=1,y=1');
...
# solver.add(y_labels[0]=='adv1:x=0,y=1, adv2:x=0,y=2')# adv1:x=0,y=1, adv2:x=0,y=2
# solver.add(y_labels[1]=='adv1:x=0,y=0, adv2:x=0,y=2')# adv1:x=1,y=0, adv2:x=0,y=2
# solver.add(y_labels[2]=='adv1:x=1,y=0, adv2:x=0,y=2')# adv1:x=1,y=0, adv2:x=0,y=2
# solver.add(y_labels[2]=='(empty)')
...
if (str(solver.check()) != "unsat"):
    ...
    for i in range(n*k):
            if "True" in str(m.evaluate(sim_vars[i], model_completion=True)):
                ...
                xstate = re.findall('(\d)-', str(sim_vars[i]))
                x_count.add(xstate[0])

    print("SAT, simulation found.")

    print('|P|  = ' + str(size_A))
    print('|Q|  = ' + str(size_B))
    print('|P\'| = ' + str(len(x_count)))
