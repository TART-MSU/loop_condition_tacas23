...
print('\n\n[ case: (E_small, A_big) RP w/o solution ]')
...
solver.add(y_labels[1]=='x=1,y=0')
solver.add(y_labels[2]=='x=2,y=0')

solver.add(y_labels[3]=='x=0,y=1')
solver.add(y_labels[4]=='x=1,y=1')
solver.add(y_labels[5]=='x=2,y=1')

solver.add(y_labels[6]=='x=0,y=2')
...
# solver.add(Or(y_labels[0]=='x=0,y=2', y_labels[0]=='x=2,y=2', y_labels[0]=='x=2,y=0'))#
# solver.add(Or(y_labels[1]=='x=1,y=2', y_labels[1]=='x=2,y=2', y_labels[1]=='x=2,y=0'))#
# solver.add(Or(y_labels[2]=='x=1,y=2', y_labels[2]=='x=2,y=1', y_labels[2]=='x=2,y=0'))#
# solver.add(Or(y_labels[3]=='x=1,y=2', y_labels[3]=='x=1,y=1', y_labels[3]=='x=1,y=0'))#
# solver.add(Or(y_labels[4]=='x=1,y=1', y_labels[4]=='x=1,y=0', y_labels[4]=='x=1,y=1'))#
# solver.add(Or(y_labels[5]=='x=1,y=1', y_labels[5]=='x=2,y=0', y_labels[5]=='x=0,y=0'))#
...
# solver.add(Or(y_labels[8]=='x=2,y=1', y_labels[8]=='x=1,y=0', y_labels[8]=='x=1,y=1'))#
